...
import { ArrowLeft, Baby, MapPin, Share2 } from "lucide-react";
...
export default function BabyShowerAlbumPage({
  params,
}: {
  ...
  const album = babyShowerAlbums.find((a) => a.id === id);
  ...
  return (
    ...
    <div className="min-h-screen bg-green-50 pt-10 pb-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          >
            ...
            Back to Baby Shower Gallery
          </a>
        </div>

        {/* Header Card (Same as Bridal, Green Theme) */}
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div>
              <div className="inline-block px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-semibold mb-3 uppercase tracking-wide">
                Baby Shower Makeup
              </div>
            ...
            <div className="flex gap-3">
              <div className="flex gap-3">
                ...
                <Button className="bg-rose-600 hover:bg-rose-700 text-white">
                  <Link href="/booking?category=baby-shower" >Book This Look</Link>
                </Button>
              </div>
            </div>
        ...
        {/* Masonry-style Grid (Same as Bridal) */}
